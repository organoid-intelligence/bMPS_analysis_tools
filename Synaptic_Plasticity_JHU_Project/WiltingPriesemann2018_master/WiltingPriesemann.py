...
# ============================================================================
def get_slopes(all_counts, k_max, scatterpoints):
...
def MR_estimation(all_counts, 
    ...
    # Get all slopes r_k
    k, r_k, intercepts, r_values, p_values, std_errs, data_length, mean_activity, xs, ys = get_slopes(all_counts, maxslopes, scatterpoints)
    ...
    p_opt, pcov = scipy.optimize.curve_fit(fitfunc,
                                        ...
                                        p0=p0,
                                        maxfev=100000,
                                        sigma=std_errs * np.linspace(1, 10, len(std_errs)))
